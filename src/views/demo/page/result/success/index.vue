<template>
  <div class="m-5 result-success">
    <Result
      status="success"
      title="四川-武侯区-东华门街-生鲜超时-提现999.258元成功"
    ...
    >
      <template #extra>
        ...
        <a-button key="buy"> 查看商品 </a-button>
        <a-button key="buy"> 打印 </a-button>
      </template>
    </Result>
    <div class="result-success__content">
      <Descriptions title="商品名称">
        <Descriptions.Item label="商品 ID"> 111222 </Descriptions.Item>
      ...
      <Steps :current="1" progress-dot size="small">
        <Steps.Step title="创建商品">
          <template #description>
            <div>Vben</div>
            <p>2016-12-12 12:32</p>
          </template>
        </Steps.Step>
        <Steps.Step title="商家初审">
          <template #description>
            <p>Chad</p>
          </template>
        </Steps.Step>
